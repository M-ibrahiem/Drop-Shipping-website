      ...
      <div class="bottom_footer">
        <div class="container">
          ...
          <div class="payment_img">
            <img src="{{ asset('front/img/payment-1.png') }}" alt="">
            <img src="{{ asset('front/img/payment-2.png') }}" alt="">
            <img src="{{ asset('front/img/payment-3.png') }}" alt="">
            <img src="{{ asset('front/img/payment-4.png') }}" alt="">
          </div>
        </div>
      </div>
    </div>
