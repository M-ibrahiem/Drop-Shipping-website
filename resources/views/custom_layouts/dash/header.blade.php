...
<head>
    ...
    <!-- Toastr CSS -->
    <link href="{{ asset('dash/vendors/jquery-toast-plugin/dist/jquery.toast.min.css') }}" rel="stylesheet"
        type="text/css">
    ...
    <div class="hk-wrapper hk-vertical-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar">
            ...
            <a class="navbar-brand" href="dashboard1.html">
                <img class="brand-img d-inline-block" src="{{ asset('dash/dist/img/logo-light.png') }}"
                    alt="brand" />
            </a>
                    ...
                    <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX"
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <button class="dropdown-item"><i
                                    class="dropdown-icon zmdi zmdi-power"></i><span>{{ __('Log Out') }}</span></button>
                        </form>
